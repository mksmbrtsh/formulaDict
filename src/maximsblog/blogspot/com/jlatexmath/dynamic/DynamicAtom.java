...
public class DynamicAtom extends Atom {
	...
	public DynamicAtom(int index, String token, String externalCode, String option) {
		super(index, token);
	...
	public static void setExternalConverterFactory(
			ExternalConverterFactory factory) {
		ecFactory = factory;
	}
	...
	public Box createBox(TeXEnvironment env) {
		...
		return new StrutBox(index, token, 0, 0, 0, 0);
	}
}