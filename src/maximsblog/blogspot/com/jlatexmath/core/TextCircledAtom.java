...
public class TextCircledAtom extends Atom {
	...
	public TextCircledAtom(int index, String token, Atom at) {
		super(index, token);
		this.at = at;
	}
	...
	public Box createBox(TeXEnvironment env) {
		...
		HorizontalBox hb = new HorizontalBox(index, token, box, circle.getWidth(),
				TeXConstants.ALIGN_CENTER);
		hb.add(new StrutBox(index, token, -hb.getWidth(), 0, 0, 0));
		hb.add(circle);
		return hb;
	}
}
