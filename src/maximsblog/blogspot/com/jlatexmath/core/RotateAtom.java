...
public class RotateAtom extends Atom {
	...
	public RotateAtom(int index, String token, Atom base, String angle, String option) {
		super(index, token);
		this.type = base.type;
		this.base = base;
	...
	public RotateAtom(int index, String token, Atom base, double angle, String option) {
		super(index, token);
		this.type = base.type;
		this.base = base;
		this.angle = angle;
	...
	public Box createBox(TeXEnvironment env) {
		if (option != -1) {
			return new RotateBox(index, token, base.createBox(env), angle, option);
		} else {
			return new RotateBox(index, token, base.createBox(env), angle, x
					* SpaceAtom.getFactor(xunit, env), y
