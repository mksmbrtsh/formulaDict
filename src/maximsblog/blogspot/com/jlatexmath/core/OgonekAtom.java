...
public class OgonekAtom extends Atom {
	...
	public OgonekAtom(int index, String token, Atom base) {
		super(index, token);
		this.base = base;
	}
	...
	public Box createBox(TeXEnvironment env) {
		...
		Box ogonek = new CharBox(index, token, ch);
		Box y;
		...
		Box og = new HorizontalBox(index, token, y, b.getWidth(), TeXConstants.ALIGN_RIGHT);
		vb.add(new StrutBox(index, token, 0, -ogonek.getHeight(), 0, 0));
		vb.add(og);
