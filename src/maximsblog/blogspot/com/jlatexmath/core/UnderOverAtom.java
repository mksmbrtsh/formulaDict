...
public class UnderOverAtom extends Atom {
	...
	public UnderOverAtom(int index, String token, Atom base, Atom underOver, int underOverUnit,
	...
	public UnderOverAtom(int index, String token, Atom base, Atom under, int underUnit,
	...
	public Box createBox(TeXEnvironment env) {
		...
		if (over != null) {
			...
			vBox.add(new SpaceAtom(index, token, overUnit, 0, overSpace, 0).createBox(env));
		}
		...
		if (under != null) {
			// unit will be valid (checked in constructor)
			vBox.add(new SpaceAtom(index, token, overUnit, 0, underSpace, 0).createBox(env));
