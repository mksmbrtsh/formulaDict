...
public class JavaFontRenderingBox extends Box {
	...
	public JavaFontRenderingBox(int index, String token, String str, int type, float size, Typeface f,
			boolean kerning) {
		super(index, token);
		this.str = str;
		this.size = size;
	...
	public JavaFontRenderingBox(int index, String token, String str, int type, float size) {
		this(index, token, str, type, size, font, true);
	}
