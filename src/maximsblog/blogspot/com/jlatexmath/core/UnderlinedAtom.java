...
class UnderlinedAtom extends Atom {
	...
	public UnderlinedAtom(int index, String token, Atom f) {
		super(index, token);
		base = f;
	...
	public Box createBox(TeXEnvironment env) {
		...
		vBox.add(b);
		vBox.add(new StrutBox(index, token, 0, 3 * drt, 0, 0));
		vBox.add(new HorizontalRule(index, token, drt, b.getWidth(), 0));
