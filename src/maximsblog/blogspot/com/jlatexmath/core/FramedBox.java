...
public class FramedBox extends Box {
	...
	public FramedBox(int index, String token, Box box, float thickness, float space) {
		super(index, token);
		this.box = box;
	...
	public FramedBox(int index, String token, Box box, float thickness, float space, Integer line,
			Integer bg) {
		this(index, token, box, thickness, space);
		this.line = line;
		this.bg = bg;
	}
