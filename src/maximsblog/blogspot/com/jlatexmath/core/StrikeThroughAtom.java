...
public class StrikeThroughAtom extends Atom {
	...
	public StrikeThroughAtom(int index, String token, Atom at) {
		super(index, token);
		this.at = at;
	}
	...
	public Box createBox(TeXEnvironment env) {
		...
		HorizontalRule rule = new HorizontalRule(index, token, drt, b.getWidth(),
				-axis + drt, false);
		HorizontalBox hb = new HorizontalBox(index, token);
		hb.add(b);
		hb.add(new StrutBox(index, token, -b.getWidth(), 0, 0, 0));
		hb.add(rule);
