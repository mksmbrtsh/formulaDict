 ...
 * 
 */
public class FileDialog extends BaseActivity implements OnItemClickListener {
	...
	public void setContentView(Bundle savedInstanceState) {
		...
		LinearLayout layoutSelect = (LinearLayout) findViewById(R.id.fdLinearLayoutCreate);
		if (selectionMode == SelectionMode.MODE_OPEN)
			layoutSelect.setVisibility(View.GONE);
		else
			layoutSelect.setVisibility(View.VISIBLE);
		
		final Button createButton = (Button) findViewById(R.id.fdButtonNew);
