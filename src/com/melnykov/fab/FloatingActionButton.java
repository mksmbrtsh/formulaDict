...
import maximsblog.blogspot.com.formuladict.CustomHorizontalScrollView;
...
public class FloatingActionButton extends ImageButton {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        mVisible = true;
        mColorNormal = getColor(R.color.fab_colorNormal);
        ...
        if (attr != null) {
            try {
                mColorNormal = attr.getColor(R.styleable.FloatingActionButton_fab_colorNormal,
                        getColor(R.color.fab_colorNormal));
    ...
    public ScrollViewScrollDetectorImpl attachToScrollView(@NonNull ObservableScrollView scrollView) {
        return attachToScrollView(scrollView, null, null);
    }

    public ScrollViewScrollDetectorImpl attachToScrollView(@NonNull ObservableScrollView scrollView,
                                   ScrollDirectionListener scrollDirectionListener) {
        return attachToScrollView(scrollView, scrollDirectionListener, null);
    }
    ...
    public ScrollViewScrollDetectorImpl attachToHScrollView(
			CustomHorizontalScrollView mHScroll) {
    	ScrollViewScrollDetectorImpl scrollDetector = new ScrollViewScrollDetectorImpl();
        scrollDetector.setScrollThreshold(mScrollThreshold);
        return scrollDetector;
	}
